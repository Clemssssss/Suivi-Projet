(function() {
  ...
  var DRILL_MAP = {
    ...
    'chart-scatter-conv-ca':   { fk:'Client',  labelFn:function(ch,i){ var d=ch.data.datasets[0]&&ch.data.datasets[0].data[i]; return d&&d.label?d.label:'?'; } },
    ...
    'chart-scatter-power-ca':  { fk:'Client',  labelFn:function(ch,i){ var d=ch.data.datasets[0]&&ch.data.datasets[0].data[i]; return d&&d.label?d.label:'?'; } },
